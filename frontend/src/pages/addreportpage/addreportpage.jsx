...
function AddReportPage({token, setBadNotification, history}) {
    ...
    return (
           ...
           <Section>
            ...
            {
                formStep === 'device' && <DeviceInformation 
                    formValues={formValues}
                    handleChange={formHandler}
            ...
            {
                formStep === 'problem' && <ProblemInformation 
                    formValues={formValues}
                    handleChange={formHandler}
            ...
            {
                formStep === 'invoice' && <InvoiceInformation 
                    formValues={formValues}
                    handleChange={formHandler}
...
export default connect (mapStatetoProps, mapDispatchtoProps) (withRouter(AddReportPage))